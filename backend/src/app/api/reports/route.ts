...
export const GET = createHandler({}, async (req: NextRequest, { user }) => {
  ...
  if (effectiveTab === "personal") {
    ...
    if (exportFormat === "csv") {
      ...
      return csvResponse(toCsv(rows), "my-tasks-report.csv") as unknown as ReturnType<typeof jsonOk>;
    }
  ...
  if (effectiveTab === "executive") {
    ...
    if (exportFormat === "csv") {
      ...
      return csvResponse(toCsv(rows), "executive-report.csv") as unknown as ReturnType<typeof jsonOk>;
    }
  ...
  if (effectiveTab === "performance") {
    ...
    if (exportFormat === "csv") {
      ...
      return csvResponse(toCsv(rows), "performance-report.csv") as unknown as ReturnType<typeof jsonOk>;
    }
  ...
  if (effectiveTab === "financial") {
    ...
    if (exportFormat === "csv") {
      ...
      return csvResponse(toCsv(rows), "financial-report.csv") as unknown as ReturnType<typeof jsonOk>;
    }
  ...
  if (effectiveTab === "project") {
    ...
    if (exportFormat === "csv") {
      ...
      return csvResponse(toCsv(rows), "project-report.csv") as unknown as ReturnType<typeof jsonOk>;
    }
  ...
  if (effectiveTab === "hr") {
    ...
    if (exportFormat === "csv") {
      ...
      return csvResponse(toCsv(rows), "hr-report.csv") as unknown as ReturnType<typeof jsonOk>;
    }
